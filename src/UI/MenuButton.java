...
public class MenuButton {
	...
	private void iniBouns() {
		bounds = new Rectangle(x-frameWidth/2,y,frameWidth,frameHeight);
	...
	private void loadIMg() {
		...
		if (temp == null) {
			System.err.println("Error: Failed to load button atlas.");
			frameWidth = 140; // Default fallback sizes
			frameHeight = 56;
			return;
		}
		int row = 3;
	...
	public void draw(Graphics g) {
		...
		//g.drawRect(x- frameWidth/2,y, frameWidth, frameHeight);
